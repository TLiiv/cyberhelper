...
import { Box, Heading, Button, VStack,HStack, Text, Highlight, Link, Blockquote, Mark, List } from "@chakra-ui/react";
    ...
    <>
      <Box maxW="1200px" mx="auto" mt={0} p={8} borderRadius="lg">
        <VStack align="stretch">
          ...
          <Text fontSize="xl" textAlign="center" display={{ base: "inline", md: "block" }}>
            Selle veebilehe peamine eesmärk on suurendada inimeste teadlikkust andmepüügist,
          </Text>
          <Text fontSize="xl" textAlign="center" display={{ base: "inline", md: "block" }}>
      ...
      <Box maxW="900px" mx="auto" mt={2} p={8} pl={10} >
          ...
          <Box flex="1" display={{ base: "none", lg: "block" }} >
           <Box maxW="900px" mx="auto" mt={2} p={8} borderRadius="lg" shadow="xl"  background="linear-gradient(135deg, rgba(0, 181, 163, 0.1), rgba(0, 72, 122, 0.1))">
        ...
        <List.Root gap="4" variant="plain" align="center">
            ...
            <Link target="_blank" rel="noopener noreferrer" href="https://www.stationx.net/phishing-statistics/" variant="underline"><Text pl={6}> — <cite>Allikad</cite></Text></Link>
        </VStack>
      </Box>
          </Box>
          </HStack>
